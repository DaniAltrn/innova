    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6 col-sm-7">
				...
				<?php // 2018/09/10 - START - Corporative header menu ?>
					<ul class="info pull-right">
						<li style="border-right: 1px solid #000; padding: 0 20px;"><a href="http://localhost/MPF-innova/blog/" title="Blog" style="font-size: 12px;"><i class="fa"></i> Blog</a></li>
						<li style="border-right: 1px solid #000; padding: 0 20px;"><a href="http://localhost/MPF-innova/contact-us/" title="Contact us" style="font-size: 12px;"><i class="fa"></i> Contact us</a></li>
						<li style="padding: 0 20px;"><a title="Select your languaje" style="font-size: 12px;"><i class="fa"></i> Idioma</a></li>
					</ul>
				<?php // 2018/09/10 - END - Corporative header menu ?>
