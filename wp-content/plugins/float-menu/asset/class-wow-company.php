	...
	*/
	final class Wow_Company{
		...
		public function add_menu() {
			...
			add_menu_page('Float Menu', 'Float Menu', 'manage_options', 'float-menu', '', $icon);	
			//add_submenu_page('wow-company', 'Get More Wow-Cmp.', 'Get More Wow-Cmp.', 'manage_options', 'wow-company');
		}
		...
		public function admin_footer_text( $footer_text ) {
			...
			if ( $wow_company_plugin == true ) {
				$rate_text = sprintf( '<span id="footer-thankyou">Developed by <a href="https://wow-estore.com/" target="_blank">Wow-Company</a> | <a href="https://www.facebook.com/wowaffect/" target="_blank">Join us on Facebook</a></span>');
