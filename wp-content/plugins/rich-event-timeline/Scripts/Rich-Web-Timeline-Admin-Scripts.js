//Admin Menu
jQuery( function() { jQuery('#datepicker').datepicker({dateFormat: 'dd.mm.yy'}); });
...
function RW_TI_Edit_TR(editNumber)
{
	...
	var ti_text = jQuery('.rw_ti_text_'+editNumber).val();
        // 2018/09/14 -- START -- Add image field from new timeline setting
	var image = jQuery('.rw_ti_image_'+editNumber).val();
	jQuery('.Rich_Web_TI_td_DO_Image_input').val(image);
        jQuery('#Rich_Web_TI_td_DO_Image_input_view').attr('src', image);
        // 2018/09/14 -- END -- Add image field from new timeline setting
...
function canselTimeline() { location.reload(); }
function canselTiOption() { location.reload(); }
...
function rw_ti_edit(ti_id) 
{
	...
	jQuery.post(ajaxurl, data, function(response) {
		...
		jQuery('.Rich_Web_TI_ST_Name').val(arr[0]);
		jQuery('.Rich_Web_TI_ST_Style').val(arr[1]);
	});
	var ajaxurl = object.ajaxurl;
	var data = {
...
function RW_TimeLine_Theme_Changed()
{
	...
	jQuery('.rw_timeline_icon_size').hide();

	var value = jQuery("#rich_web_timeline_theme").val();
	if(value == '1')
	{
		jQuery("#RW_Ti_Option_TiTable").show(); jQuery("#RW_Ti_Option_TiTable_2").hide(); jQuery(".rw_timeline_year_bg").hide(); jQuery(".rich_web_timeline_ybs").hide(); jQuery(".rw_ti_border_opt").show(); jQuery(".RW_Op_Title_Round").show(); jQuery(".rw_timeline_year_border_col").hide(); jQuery(".rw_ti_month_opt").hide(); jQuery(".rw_timeline_icons_tr_st").hide(); jQuery(".rw_timeline_md_op_st").hide(); jQuery(".rw_timeline_line_col").show(); jQuery('.rw_timeline_data_format').hide(); jQuery('.rw_timeline_icon_size').show();
	}
	else
	{
		jQuery("#RW_Ti_Option_TiTable").show(); jQuery("#RW_Ti_Option_TiTable_2").hide(); jQuery(".rw_timeline_year_bg").show(); jQuery(".rich_web_timeline_ybs").hide(); jQuery(".rw_ti_border_opt").hide(); jQuery('.rw_timeline_data_format').hide();
	}
	if(value == '2')
	{
		jQuery(".RW_Op_Title_Round").hide(); jQuery(".rw_timeline_year_border_col").hide(); jQuery(".rw_ti_month_opt").hide(); jQuery(".rw_timeline_icons_tr_st").hide(); jQuery(".rw_timeline_md_op_st").hide(); jQuery(".rw_timeline_line_col").show(); jQuery('.rw_timeline_data_format').hide(); jQuery('.rw_timeline_icon_size').hide();
	}
	if(value == '3')
	{
		jQuery("#RW_Ti_Option_TiTable").show(); jQuery("#RW_Ti_Option_TiTable_2").hide(); jQuery(".rw_timeline_icons_tr").show(); jQuery(".rw_timeline_year_bg").hide(); jQuery(".rich_web_timeline_ybs").hide(); jQuery(".rw_ti_border_opt").hide(); jQuery(".RW_Op_Title_Round").show(); jQuery(".rw_timeline_year_border_col").show(); jQuery(".rw_ti_month_opt").hide(); jQuery(".rw_timeline_icons_tr_st").hide(); jQuery(".rw_timeline_md_op_st").hide(); jQuery(".rw_timeline_line_col").show(); jQuery('.rw_timeline_data_format').hide(); jQuery('.rw_timeline_icon_size').show();
	}
	else
	{
		jQuery(".rw_timeline_icons_tr").hide();
	...
	if(value == '4')
	{
		jQuery("#RW_Ti_Option_TiTable").show(); jQuery(".rich_web_timeline_ybs").show(); jQuery("#RW_Ti_Option_TiTable_2").hide(); jQuery(".rw_ti_border_opt").hide(); jQuery(".RW_Op_Title_Round").show(); jQuery(".rw_timeline_year_border_col").hide(); jQuery(".rw_ti_month_opt").hide(); jQuery(".rw_timeline_icons_tr_st").hide(); jQuery(".rw_timeline_md_op_st").hide(); jQuery(".rw_timeline_line_col").show(); jQuery('.rw_timeline_data_format').hide(); jQuery('.rw_timeline_icon_size').show();
	}
	if(value == '5' || value == '6')
	{
		jQuery("#RW_Ti_Option_TiTable").hide(); jQuery("#RW_Ti_Option_TiTable_2").show(); jQuery(".rich_web_timeline_ybs").hide(); jQuery(".rw_ti_border_opt").hide(); jQuery(".RW_Op_Title_Round").show(); jQuery(".rw_timeline_year_border_col").hide(); jQuery(".rw_ti_month_opt").hide(); jQuery(".rw_timeline_icons_tr_st").hide(); jQuery(".rw_timeline_md_op_st").hide(); jQuery(".rw_timeline_line_col").show(); jQuery('.rw_timeline_data_format').hide(); jQuery('.rw_timeline_icon_size').hide();
	}
	if(value == '7')
	{
		jQuery("#RW_Ti_Option_TiTable").show(); jQuery(".rich_web_timeline_ybs").show(); jQuery("#RW_Ti_Option_TiTable_2").hide(); jQuery(".rich_web_timeline_ybs").hide(); jQuery(".rw_timeline_icons_tr").show(); jQuery(".rw_ti_border_opt").show(); jQuery(".RW_Op_Title_Round").hide(); jQuery(".rw_timeline_year_border_col").hide(); jQuery(".rw_ti_month_opt").show(); jQuery(".rw_timeline_icons_tr_st").show(); jQuery(".rw_timeline_md_op_st").show(); jQuery(".rw_timeline_line_col").hide(); jQuery('.rw_timeline_data_format').show(); jQuery('.rw_timeline_icon_size').hide();
	}
}
function rw_ti_edit_option(ti_id) 
{
	...
	jQuery.ajax({
		...
		success: function(response){
			...
			jQuery('#rich_web_timeline_title').val(data[0]['rw_timeline_title']);
			jQuery('#rich_web_timeline_theme').val(data[0]['rw_timeline_theme']);
			if(data[0]['rw_timeline_theme'] == '1' || data[0]['rw_timeline_theme'] == '2' || data[0]['rw_timeline_theme'] == '3' || data[0]['rw_timeline_theme'] == '4' || data[0]['rw_timeline_theme'] == '5' || data[0]['rw_timeline_theme'] == '6' || data[0]['rw_timeline_theme'] == '7')
			{
				jQuery('.rich_web_timeline_title_color').val(data[0]['rw_timeline_title_col']); jQuery('.rich_web_timeline_border_color').val(data[0]['rw_timeline_border_col']); jQuery('.rich_web_timeline_number_color').val(data[0]['rw_timeline_number_col']); jQuery('.rich_web_timeline_line_color').val(data[0]['rw_timeline_line_col']); jQuery('.rich_web_timeline_font_size').val(data[0]['rw_timeline_font_size']); jQuery('.rich_web_timeline_color_font_family').val(data[0]['rich_web_timeline_fonts']); jQuery('.rich_web_timeline_md_color').val(data[0]['rw_timeline_md_color']); jQuery('.rich_web_timeline_hover_color').val(data[0]['rw_timeline_hover_color']); jQuery('.rich_web_timeline_sort').val(data[0]['rw_timeline_sort']); jQuery('.rich_web_timeline_effect').val(data[0]['rw_timeline_effect']); jQuery('.rich_web_timeline_round_bg').val(data[0]['rw_timeline_round_bg']); jQuery('.rich_web_timeline_round_bg_hover').val(data[0]['rw_timeline_round_bg_hover']); jQuery('.rich_web_timeline_round_border_px').val(data[0]['rw_timeline_round_border_px']); jQuery('.rich_web_timeline_border_px').val(data[0]['rw_timeline_border_px']); jQuery('.rich_web_timeline_box_shadow').val(data[0]['rw_timeline_box_shadow']); jQuery('.rich_web_timeline_box_shadow_px').val(data[0]['rw_timeline_box_shadow_px']); jQuery('.rich_web_timeline_border_type_article').val(data[0]['rw_timeline_border_type_article']); jQuery('.rich_web_timeline_border_type_line').val(data[0]['rw_timeline_border_type_line']); jQuery('.rich_web_timeline_icon_type').val(data[0]['rw_timeline_icon_type']); jQuery('.rich_web_timeline_icon_color').val(data[0]['rw_timeline_icon_color']); jQuery('.rich_web_timeline_icon_size').val(data[0]['rw_timeline_icon_size']); jQuery('.rich_web_timeline_year_block_bg').val(data[0]['rw_timeline_year_block_bg']); jQuery('.rich_web_timeline_round_size').val(data[0]['rw_timeline_round_size']); jQuery('.rich_web_timeline_bg_color').val(data[0]['rw_timeline_bg_color']); jQuery('.rich_web_timeline_bg_color_hover').val(data[0]['rw_timeline_bg_color_hover']); jQuery('.rich_web_timeline_box_shadow_hover').val(data[0]['rw_timeline_box_shadow_hover']); jQuery('.rich_web_timeline_year_color_hover').val(data[0]['rw_timeline_year_color_hover']); jQuery('.rich_web_timeline_year_block_bg_hover').val(data[0]['rw_timeline_year_block_bg_hover']); jQuery('.rich_web_timeline_year_size').val(data[0]['rw_timeline_year_size']); jQuery('.rich_web_timeline_md_color_hover').val(data[0]['rw_timeline_md_color_hover']); jQuery('.rich_web_timeline_md_border_color').val(data[0]['rw_timeline_md_border_color']); jQuery('.rich_web_timeline_md_border_color_hover').val(data[0]['rw_timeline_md_border_color_hover']); jQuery('.rich_web_timeline_round_border_col').val(data[0]['rw_timeline_round_border_col']); jQuery('.rich_web_timeline_round_border_col_hover').val(data[0]['rw_timeline_title_bg_color']); jQuery('.rich_web_timeline_title_bg_color').val(data[0]['rw_timeline_round_border_col_hover']); jQuery('.rich_web_timeline_year_border_color').val(data[0]['rw_timeline_01']); jQuery('.rich_web_timeline_year_border_hover_color').val(data[0]['rw_timeline_02']);
			}
		}
	});
	...
	jQuery.ajax({
		...
		success: function(response){
			...
			if(data[0]['rw_timeline_month_col'] != '' || data[0]['rw_timeline_month_col_hov'] != '' || data[0]['rw_timeline_icon_col'] != '' || data[0]['rw_timeline_icon_size'] != '' || data[0]['rw_timeline_icon_style'] != '' || data[0]['rw_timeline_md_bg_color'] != '' || data[0]['rw_timeline_md_bg_color_hover'] != '')
			{
				jQuery('.rich_web_timeline_month_col').val(data[0]['rw_timeline_month_col']); jQuery('.rich_web_timeline_month_col_hov').val(data[0]['rw_timeline_month_col_hov']); jQuery('.rich_web_timeline_icon_color_st').val(data[0]['rw_timeline_icon_col']); jQuery('.rich_web_timeline_icon_size_st').val(data[0]['rw_timeline_icon_size']); jQuery('.rich_web_timeline_icon_type_st').val(data[0]['rw_timeline_icon_style']); jQuery('.rich_web_timeline_md_bg_color').val(data[0]['rw_timeline_md_bg_color']); jQuery('.rich_web_timeline_md_color_bg_hover').val(data[0]['rw_timeline_md_bg_color_hover']); jQuery('#RW_TimeLine_7_DFormat').val(data[0]['rw_timeline_01']); jQuery('#RW_TimeLine_IS').val(data[0]['rw_timeline_02']);
			}
			setTimeout(function(){
				RW_TimeLine_Theme_Changed();
				rangeGI();
...
{
	var slider = jQuery('.range-timeline'), range = jQuery('.range-timeline__range'), value = jQuery('.range-timeline__value');
	slider.each(function() {
		value.each(function() { var value = jQuery(this).prev().attr('value'); jQuery(this).html(value); });
		range.on('input', function() { jQuery(this).next(value).html(this.value);});
	});
};
rangeGI();
